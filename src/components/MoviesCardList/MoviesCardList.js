...
import MoviesItem from '../MoviesItem/MovieItem';
import { useLocation } from 'react-router-dom';
import { MOVIES_NOT_FOUND_ERROR, CONNECTION_OR_SERVER_ERROR } from '../../utils/constants/errorsConstants';
import { ZERO_CARDS } from '../../utils/constants/cardsConstants';
...
function MoviesCardList({   
  ...
  return (
    <section className={`movies-card-list ${place === 'saved-movies' ? 'movies-card-list_place_saved-movies' : ''}`}>
        ...
        >
          {!isRequestSuccessful ? CONNECTION_OR_SERVER_ERROR : MOVIES_NOT_FOUND_ERROR}
        </p>
      ) : (
